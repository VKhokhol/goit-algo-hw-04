...
#Обробка винятку, який виникає у випадку, коли зарплата написана у текстовому вигляді
    ...
    print('Дані повинні бути у форматі: "Ім\'я,зарплата(цифрами)')
#Обробка винятку, який виникає, якщо дані записані у бітовому форматі
except TypeError:
    print('Неправильний тип даних')
#Обробка винятку, який виникає, якщо читання файлу відбувається з неправильним кодуванням
except UnicodeDecodeError:
    print('Неправильне кодування')
#Обробка винятку, який виникає, якщо файл відсутній
